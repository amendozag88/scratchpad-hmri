#!/bin/bash -l
#SBATCH --job-name=clean_ecg_df					# Give your job a name, so you can recognize it in the queue overview
...
#
python /condo/alkindilab/hmaiaxg21/PDF_to_numpy_pipeline/3_clean_df_from_ecgs_Jun2.py  --input_dir /condo/alkindilab/hmaiaxg21/PDF_to_numpy_pipeline --output_dir /condo/alkindilab/hmaiaxg21/PDF_to_numpy_pipeline
