...
#
python /condo/alkindilab/hmaiaxg21/PDF_to_numpy_pipeline/2_svg_to_numpy_antonio_Jun2.py --output_dir /condo/alkindilab/hmaiaxg21/PDF_to_numpy_pipeline/test_2_svg_to_numpy --svg_folder /condo/alkindilab/hmaiaxg21/ecg_pdf_output/20xx/svg/ --end_index 1000
